            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    @empty($kategori)
                        ...
                        <a href="{{ route('kategori.index') }}" class="btn btn-sm btn-default mt-2">Kembali</a>
                    @else
                        <form method="POST" action="{{ route('kategori.update', $kategori->kategori_id) }}" class="formhorizontal">
                            @csrf
                            @method('PUT')
